/**
 * USB HID keyboard key codes as per USB usage table doc version 1.5.
 * See the "HID Usage Tables for USB" document
 * section 10, Keyboard/Keypad Page (0x07).
 * 
 * This is slightly modified from the original:
 * Some defines were removed. Only page 0x7 key codes are included.
 * Added an underscore to the keypad defines so they are prefixed with KEY_KP_.
 * 
 * Original created by MightyPork, 2016
 ...
 * The corresponding modifier key codes are at the bottom of the key code list,
 * near the end of this file.
 */
#define KEY_MOD_LEFTCTRL   0x01
#define KEY_MOD_LEFTSHIFT  0x02
#define KEY_MOD_LEFTALT    0x04
#define KEY_MOD_LEFTMETA   0x08
#define KEY_MOD_RIGHTCTRL  0x10
#define KEY_MOD_RIGHTSHIFT 0x20
#define KEY_MOD_RIGHTALT   0x40
#define KEY_MOD_RIGHTMETA  0x80

/**
 * Key codes - last N slots in the HID report (usually 6).
 * 0x00 if no key pressed.
 * 
 * If more than N keys are pressed, the HID reports 
 * KEY_ERR_ROLLOVER in all slots to indicate this condition.
 */

#define KEY_NONE 0x00 // No key pressed
#define KEY_ERR_ROLLOVER 0x01 // Keyboard Error Roll Over - used for all slots if too many keys are pressed ("Phantom key")
#define KEY_POSTFAIL 0x02 // Keyboard POST Fail
...
#define KEY_PRINTSCREEN 0x46 // Keyboard Print Screen
...
#define KEY_KP_9 0x61 // Keypad 9 and Page Up
...
#define KEY_KP_EQUAL_UNIX 0x86 // Keypad Equal Sign on AS/400 (Unix)
...
#define KEY_KP_JPCOMMA 0x8c // Keyboard International6
...
#define KEY_KP_LEFTPAREN 0xb6 // Keypad (
#define KEY_KP_RIGHTPAREN 0xb7 // Keypad )
#define KEY_KP_LEFTBRACE 0xb8 // Keypad {
#define KEY_KP_RIGHTBRACE 0xb9 // Keypad }
// 0xba  Keypad Tab
 ...
 * For a standard keyboard HID report the first byte is the modifer key bitmask.
 * Do a bitwise and with 0x7 to get the corresponding bit in the modifer byte.
 */
#define KEY_LEFTCTRL 0xe0 // Keyboard Left Control
#define KEY_LEFTSHIFT 0xe1 // Keyboard Left Shift
#define KEY_LEFTALT 0xe2 // Keyboard Left Alt
#define KEY_LEFTMETA 0xe3 // Keyboard Left GUI/Win/Apple/Meta
#define KEY_RIGHTCTRL 0xe4 // Keyboard Right Control
#define KEY_RIGHTSHIFT 0xe5 // Keyboard Right Shift
#define KEY_RIGHTALT 0xe6 // Keyboard Right Alt
#define KEY_RIGHTMETA 0xe7 // Keyboard Right GUI/Win/Apple/Meta

#endif // _USB_HID_KEYS_H_
